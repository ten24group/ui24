...
import { PageConfigEntry, isPageConfigEntry } from '../types/pageConfig';
...
export interface ResolveRouteResult {
  ...
  pageConfig: PageConfigEntry | null;
...
export const useResolveRoute = (
  ...
  return useMemo(() => {
    ...
    for (const [ key, pageEntry ] of Object.entries(pagesConfig)) {
      const page = pageEntry as PageConfigEntry;
